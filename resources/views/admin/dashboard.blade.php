...
<body>
    ...
    <div class="main">
        <h1>Welcome</h1>
        <div>
            <a href="{{ route('admins.create') }}" class="btn">Registrasi Admin</a>
            <a href="/createvendor" class="btn">Registrasi Vendor</a>
            <a href="/createtimit" class="btn">Registrasi Tim IT</a>
        </div>
    </div>
</body>
</html>
